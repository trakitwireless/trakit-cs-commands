...
namespace Trakit.Commands {
	...
	public abstract class PayProviderConfigurationList : Payload, IPayDeletable {
		/// <summary>
	...
	public class PayProviderConfigurationListByCompany : PayProviderConfigurationList, IPayListByCompany {
		/// <summary>
