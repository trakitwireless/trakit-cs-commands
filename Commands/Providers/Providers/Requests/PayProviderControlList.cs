...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayProviderControlList : Payload, IPayDeletable, IPaySuspendable {
		/// <summary>
	...
	/// </summary>
	public class PayProviderControlListByCompany : PayProviderControlList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayProviderControlListByCompanyAndLabels : PayProviderControlListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayProviderControlListByCompanyAndRefPairs : PayProviderControlListByCompany, IPayListByReferences {
		/// <summary>
