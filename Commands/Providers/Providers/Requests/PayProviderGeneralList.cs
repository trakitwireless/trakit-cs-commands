...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayProviderGeneralList : Payload, IPayDeletable, IPaySuspendable {
		/// <summary>
	...
	/// </summary>
	public class PayProviderGeneralListByCompany : PayProviderGeneralList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayProviderGeneralListByCompanyAndLabels : PayProviderGeneralListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayProviderGeneralListByCompanyAndRefPairs : PayProviderGeneralListByCompany, IPayListByReferences {
		/// <summary>
