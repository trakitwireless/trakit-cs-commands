...
namespace Trakit.Commands {
	...
	/// 
	/// </summary>
	public abstract class PayDispatchTaskList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayDispatchTaskListByAsset : PayDispatchTaskList, IPayListByAsset {
		/// <summary>
	...
	/// </summary>
	public class PayDispatchTaskListByAssetAndRefPairs : PayDispatchTaskListByAsset {
		/// <summary>
	...
	/// </summary>
	public class PayDispatchTaskListByCompany : PayDispatchTaskList, IPayListByCompany {
		/// <summary>
		/// Identifier of the <see cref="Company"/> to which this collection belongs.
		/// </summary>
	...
	/// If a reference value is null, it will match any <see cref="DispatchTask"/> without that reference key.
	/// </summary>
	public class PayDispatchTaskListByCompanyAndRefPairs : PayDispatchTaskListByCompany, IPayListByReferences {
		/// <summary>
		/// Case-insensitive reference pairs used to match jobs.
		/// </summary>
		/// <seealso cref="DispatchTask.references"/>
