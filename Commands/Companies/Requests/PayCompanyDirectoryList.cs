...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayCompanyDirectoryList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyDirectoryListByCompany : PayCompanyDirectoryList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyDirectoryListByCompanyAndLabels : PayCompanyDirectoryListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyDirectoryListByCompanyAndRefPairs : PayCompanyDirectoryListByCompany, IPayListByReferences {
		/// <summary>
