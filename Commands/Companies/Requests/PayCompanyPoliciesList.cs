...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayCompanyPoliciesList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyPoliciesListByCompany : PayCompanyPoliciesList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyPoliciesListByCompanyAndLabels : PayCompanyPoliciesListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyPoliciesListByCompanyAndRefPairs : PayCompanyPoliciesListByCompany, IPayListByReferences {
		/// <summary>
