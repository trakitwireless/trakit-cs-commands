...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayCompanyStylesList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyStylesListByCompany : PayCompanyStylesList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyStylesListByCompanyAndLabels : PayCompanyStylesListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyStylesListByCompanyAndRefPairs : PayCompanyStylesListByCompany, IPayListByReferences {
		/// <summary>
