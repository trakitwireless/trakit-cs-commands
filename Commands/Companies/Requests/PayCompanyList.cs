...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayCompanyList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyListByCompany : PayCompanyList, IPayListByCompany {
		/// <summary>
	...
	/// Contains the <see cref="Company.id"/> of the collection.
	/// </summary>
	public class PayCompanyListByCompanyAndRefPairs : PayCompanyListByCompany, IPayListByReferences {
		/// <summary>
