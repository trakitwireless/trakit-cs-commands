...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayCompanyResellerList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyResellerListByCompany : PayCompanyResellerList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyResellerListByCompanyAndLabels : PayCompanyResellerListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayCompanyResellerListByCompanyAndRefPairs : PayCompanyResellerListByCompany, IPayListByReferences {
		/// <summary>
