...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayAssetDispatchList : Payload, IPayDeletable, IPaySuspendable {
		/// <summary>
	...
	/// </summary>
	public class PayAssetDispatchListByCompany : PayAssetDispatchList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayAssetDispatchListByCompanyAndLabels : PayAssetDispatchListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayAssetDispatchListByCompanyAndRefPairs : PayAssetDispatchListByCompany, IPayListByReferences {
		/// <summary>
