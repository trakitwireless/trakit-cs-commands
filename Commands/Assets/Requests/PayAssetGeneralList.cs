...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayAssetGeneralList : Payload, IPayDeletable, IPaySuspendable {
		/// <summary>
	...
	/// </summary>
	public class PayAssetGeneralListByCompany : PayAssetGeneralList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayAssetGeneralListByCompanyAndLabels : PayAssetGeneralListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayAssetGeneralListByCompanyAndRefPairs : PayAssetGeneralListByCompany, IPayListByReferences {
		/// <summary>
