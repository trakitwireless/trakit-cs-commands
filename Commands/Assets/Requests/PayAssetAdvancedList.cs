...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayAssetAdvancedList : Payload, IPayDeletable, IPaySuspendable {
		/// <summary>
	...
	/// </summary>
	public class PayAssetAdvancedListByCompany : PayAssetAdvancedList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayAssetAdvancedListByCompanyAndLabels : PayAssetAdvancedListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayAssetAdvancedListByCompanyAndRefPairs : PayAssetAdvancedListByCompany, IPayListByReferences {
		/// <summary>
