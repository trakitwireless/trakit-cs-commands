...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayAssetList : Payload, IPayDeletable, IPaySuspendable {
		/// <summary>
	...
	/// </summary>
	public class PayAssetListByCompany : PayAssetList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayAssetListByCompanyAndLabels : PayAssetListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayAssetListByCompanyAndRefPairs : PayAssetListByCompany, IPayListByReferences {
		/// <summary>
