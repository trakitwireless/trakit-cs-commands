...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayMaintenanceScheduleList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayMaintenanceScheduleListByCompany : PayMaintenanceScheduleList, IPayListByCompany {
		/// <summary>
