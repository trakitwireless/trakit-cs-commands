...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayUserGeneralList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayUserGeneralListByCompany : PayUserGeneralList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayUserGeneralListByCompanyAndLabels : PayUserGeneralListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayUserGeneralListByCompanyAndRefPairs : PayUserGeneralListByCompany, IPayListByReferences {
		/// <summary>
