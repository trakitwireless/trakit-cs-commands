...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class PayUserAdvancedList : Payload, IPayDeletable {
		/// <summary>
	...
	/// </summary>
	public class PayUserAdvancedListByCompany : PayUserAdvancedList, IPayListByCompany {
		/// <summary>
	...
	/// </summary>
	public class PayUserAdvancedListByCompanyAndLabels : PayUserAdvancedListByCompany, IPayListByLabels {
		/// <summary>
	...
	/// </summary>
	public class PayUserAdvancedListByCompanyAndRefPairs : PayUserAdvancedListByCompany, IPayListByReferences {
		/// <summary>
